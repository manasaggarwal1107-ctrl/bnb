...
def open_settings():
    ...
    new_cooldown = simpledialog.askinteger("Advanced Settings", "Enter cooldown time (seconds):", minvalue=1, initialvalue=10)
    if new_cooldown:
        cooldown_time = timedelta(seconds=new_cooldown)
        messagebox.showinfo("Settings Updated", f"Cooldown time set to {new_cooldown} seconds.")
...
settings_button = tk.Button(button_frame, text="Advanced Settings", font=("Helvetica", 16), command=open_settings)
